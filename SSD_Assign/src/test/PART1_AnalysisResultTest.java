...
class PART1_AnalysisResultTest {
	...
	void testGetLongestWord() {
		...
		ar.recordWord("Robot");
		assertEquals("Robot", ar.getLongestWord(),
				"Should have matching longest word when multi-character word recorded");

		ar.recordWord("Work");
		assertEquals("Robot", ar.getLongestWord(),
				"Should have unchanged longest word when lower-character word recorded");
		...
		ar.recordWord("Shout");
		assertEquals("Robot", ar.getLongestWord(),
				"Should have unchanged longest word when equal length character word recorded");

		ar.recordWord("Person");
		assertEquals("Person", ar.getLongestWord(), "Should have matching longest word when longer word recorded");

		ar.recordWord("Spy");
		assertEquals("Person", ar.getLongestWord(),
				"Should have unchanged longest word when lower-character word recorded");

		ar.recordWord("");
		assertEquals("Person", ar.getLongestWord(),
				"Should have unchanged longest word when empty-character word recorded");
	...
	void testGetShortestWord() {
		...
		ar.recordWord("Robot");
		assertEquals("Robot", ar.getShortestWord(),
				"Should have matching shortest word when multi-character word recorded");

		ar.recordWord("Working");
		assertEquals("Robot", ar.getShortestWord(),
				"Should have unchanged shortest word when higher-character word recorded");
		...
		ar.recordWord("Shout");
		assertEquals("Robot", ar.getShortestWord(),
				"Should have unchanged shortest word when equal length character word recorded");

		ar.recordWord("Spy");
		assertEquals("Spy", ar.getShortestWord(),
				"Should have updated shortest word when lower-character word recorded");
		...
		ar.recordWord("");
		assertEquals("Spy", ar.getShortestWord(),
				"Should have unchanged shortest word when empty-character word recorded");
	...
	void testRecordTrimmedWord() {
		...
		assertEquals(15, ar.getTotalChars(),
				"The character count should be based on the actual words recorded (after trimming)");
	}
	...
	void testGetAveWordLength() {
		...
		ar.recordWord("test");
		assertEquals(4.0, ar.getAveWordLength(),
				"Should have matching average word length when only one word recorded");

		ar.recordWord("test");
		assertEquals(4.0, ar.getAveWordLength(),
				"Should have matching average word length when same word recorded more than once");

		ar.recordWord("seventy");
		assertEquals(5.0, ar.getAveWordLength(),
				"Should have average word length when same word recorded more than once");
	...
	void testAllCalls() {
		...
		for (int i = 0; i < repCount; i++) {
			...
			assertEquals(wordLen * (i + 1), ar.getTotalChars(),
					"Should have correct character count after each word recorded");
		}

		assertEquals(wordLen * repCount, ar.getTotalChars(),
				"Should have correct character count after multiple words recorded");
		...
		assertEquals((double) wordLen, ar.getAveWordLength(),
				"Should have consistent average word length after multiple words recorded");
		assertEquals(word, ar.getLastWord(), "Last recorded word should always match");
